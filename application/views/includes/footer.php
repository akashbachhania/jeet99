...
<div class="row">
   ...
   <div class="col-md-2 col-sm-4 col-xs-12">
    ...
    <div class="FooterData">
       	  <h2>Support</h2>
            <ul>
                <li><a href="https://99soundhelp.zendesk.com/hc/en-us/categories/204090247-FAQ" target="_blank"><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Frequently Asked Questions</a></li>
...
<div class="row">
	<div class="col-md-6">
    <p>©2016 By 99SOUND.COM INC. All Rights Reserved</p>
    </div>
    ...
    <div class="col-md-6">
        ...
        <li>   <a href="https://www.facebook.com/99sounds" data-toggle="tooltip" data-placement="left" title="Facebook" class="icon_social"><i class="fa fa-facebook"></i><!--<img src="<?php echo base_url() ?>assets/icon/fb.png" />--></a></li>
        </ul>
    </div>
</div>
</div>	
