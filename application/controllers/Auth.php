...
class Auth extends CI_Controller
{
 ...
 return $pageURL;
    ...
    public function forgotPass()
    {
        ...
        if ($this->form_validation->run() != false) {
            ...
            if (!empty($user)) {
                ...
                $this->email->to($email);
                $this->email->subject('99Sound forgot password');
    ...
    public function sendVerificationMail($email, $token){
        ...
        $data['subject_main'] = 'Congratulation and welcome to 99SOUND.COM, where both Artists & Fans EARN MONEY by selling Your Music!';
        ...
        $this->email->from('info@99sound.com', '99 Sound');
        $this->email->to($email);
        $this->email->subject('Verify your e-mail address for your 99Sound.com account.');
        $this->email->message($message);
        $this->email->send();
    }
